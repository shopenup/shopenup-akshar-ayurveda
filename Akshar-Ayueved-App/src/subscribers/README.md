...
Subscribers handle events emitted in the Shopenup application.
...
- `container`: The Shopenup container. Use it to resolve modules' main services and other registered resources.
