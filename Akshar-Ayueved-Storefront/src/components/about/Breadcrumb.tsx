...
export default function Breadcrumb({ title, crumbs, imageSrc }: BreadcrumbProps) {
  return (
    <div 
      className="sticky z-10 top-0 left-0 w-full h-[344px] bg-cover bg-center bg-no-repeat py-[170px] px-0 flex items-center justify-center"
      style={{
      ...
      <div className="relative z-[2]">
        <div className="max-w-[1200px] mx-auto px-[15px]">
          <div className="flex flex-wrap -mx-[15px]">
            <div className="w-full mt-[70px] px-[15px]">
              <div className="text-center">
                <h2 className="text-[30px] font-bold text-white pb-2 capitalize">
                  {title}
                </h2>
                <div className="font-medium text-white inline-flex flex-wrap gap-[10px] text-[18px]">
                  {crumbs.map((c, idx) => (
