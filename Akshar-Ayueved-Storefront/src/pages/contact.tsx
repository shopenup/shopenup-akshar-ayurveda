...
export default function ContactPage() {
    ...
    try {
      const res = await sdk.client.fetch<{ success: boolean; error?: string }>(
        "/store/custom/contact",
        {
          method: "POST",
          body: values,
          next: { tags: ["contact-form"] }, // optional caching/tagging
        }
      )
  ...
  return (
    ...
    {/* Breadcrumb Section */}
        <Breadcrumb title="Contact Us" crumbs={[{ label: 'Home', href: '/' }, { label: 'Contact Us' }]} imageSrc="/assets/images/bredcrumb-bg.jpg" />
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-[#CD8973] rounded-lg flex items-center justify-center mr-4">
