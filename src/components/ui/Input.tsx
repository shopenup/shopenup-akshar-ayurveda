...
const Input: React.FC<InputProps> = ({
  ...
  const inputClasses = `block ${widthClass} ${sizeClasses[size]} border rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 ${errorClass} ${disabledClass} ${className}`;
